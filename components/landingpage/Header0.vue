...
<template>
  <div class="h-screen flex items-center justify-center bg-website-950">
    ...
    />
    <div class="relative z-10 text-website-50 flex flex-col p-6 sm:p-12 lg:p-24 items-start justify-center gap-8 max-w-7xl">
      <div>
