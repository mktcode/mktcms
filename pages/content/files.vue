...
<template>
  <div>
    ...
    <div class="mt-10 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
      <div v-for="file in files" :key="file" class="bg-white shadow-sm rounded-lg p-2">
        <img :src="`/files/${file}`" alt="Kein Bild" class="w-full h-40 object-cover object-center rounded-lg" />
      </div>
    </div>
  </div>
</template>